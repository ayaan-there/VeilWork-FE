...
export class Contract {
  ...
  constructor(...args_0) {
      ...
      get: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('get',
                                     'argument 1 (as invoked from Typescript)',
                                     'counter.compact line 68 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        const context = { ...contextOrig_0, gasCost: __compactRuntime.emptyRunningCost() };
    ...
    this.impureCircuits = {
      publicKey: this.circuits.publicKey,
  ...
  initialState(...args_0) {
    ...
    if (!(typeof(initialCount_0) === 'bigint' && initialCount_0 >= 0n && initialCount_0 <= 18446744073709551615n)) {
      __compactRuntime.typeError('Contract state constructor',
    ...
    state_0.setOperation('publicKey', new __compactRuntime.ContractOperation());
    ...
    __compactRuntime.queryLedgerState(context,
                                      ...
                                      [
                                       ...
                                       { ins: { cached: true, n: 1 } }]);
    const tmp_1 = this._publicKey_0(context, partialProofData, ownerSecret_0);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
                                      ...
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_8.toValue(1n),
                                                                                              alignment: _descriptor_8.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(initialCount_0),
                                                                                              alignment: _descriptor_0.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    ...
    __compactRuntime.assert(this._equal_0(_descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                                    ...
                                                                                                    [
                                                                                                     ...
                                                                                                     { popeq: { cached: false,
                                                                                                                result: undefined } }]).value),
                                          pk_0),
                            'increment: caller is not the owner');
    const tmp_0 = ((t1) => {
                    if (t1 > 18446744073709551615n) {
                      throw new __compactRuntime.CompactError('counter.compact line 42 char 22: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 18446744073709551615');
                    }
                    return t1;
                  })(_descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                               partialProofData,
    ...
    __compactRuntime.assert(this._equal_1(_descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                                    ...
                                                                                                    [
                                                                                                     ...
                                                                                                     { popeq: { cached: false,
                                                                                                                result: undefined } }]).value),
                                          pk_0),
                            'decrement: caller is not the owner');
    let t_0;
  ...
  _reset_0(context, partialProofData) {
    ...
    __compactRuntime.queryLedgerState(context,
                                      ...
                                      [
                                       ...
                                       { ins: { cached: true, n: 1 } }]);
    const tmp_2 = this._publicKey_0(context, partialProofData, sk_0);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
